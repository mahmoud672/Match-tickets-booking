<?php	
  ...
  $sql_query="select level_id,level_name from tbl_levels";
  ...
  <script type="text/javascript">
	...
	<section class="content-header">
	  ...
	  <ol class="breadcrumb">
	    ...
	    <li class="active">List All Levels</li>
	  </ol>
	</section>		
   <div class="col-md-12">
   <h4>All Levels</h4>
              ...
              <tr>
                  ...
                  <td>
                     <p data-placement="top" data-toggle="tooltip" title="Delete">
                      <button class="btn btn-danger btn-xs confirm-delete" data-title="Delete" data-toggle="modal"  data-id="<?php echo $row['level_id'];?>">
  	...
  	<div class="col-md-6">
          ...
          <fieldset>
            <div id="legend">
              ...
              <legend class="">Add New Level</legend>
            </div>
            <div class="control-group">
              <label class="control-label" for="levelname">Level Name</label>
              <div class="controls">
                <input type="text" id="level_name" name="level_name" placeholder="" class="form-control input-md">
            ...
            <div class="control-group">
              <!-- Button -->
              <div class="controls">
                <input type="button" class="btn btn-success" id="AddNewLevel" value="Add"/>
              </div>
            </div>
            <br>
          </fieldset>
