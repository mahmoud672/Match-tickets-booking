...
?>
  ...
  <script type="text/javascript">
	...
	<section class="content-header">
	  <h1>
	    Dashboard
	    <small>All Places</small>
	  </h1>
	  <ol class="breadcrumb">
	    <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
	    <li class="active">List All Places</li>
	  </ol>
	</section>		
   <div class="col-md-12">
   <h4>All Places</h4>
              ...
              <tr>
                  ...
                  <td>
                     <p data-placement="top" data-toggle="tooltip" title="Delete">
                      <button class="btn btn-danger btn-xs confirm-delete" data-title="Delete" data-toggle="modal"  data-id="<?php echo $row['place_id'];?>">
  	...
  	<div class="col-md-6">
          ...
          <fieldset>
            <div id="legend">
              ...
              <legend class="">Add New Place</legend>
            </div>
            <div class="control-group">
              <label class="control-label" for="placeName">Place Name</label>
              <div class="controls">
                <input type="text" id="place_name" name="place_name" placeholder="" class="form-control input-md">
            ...
            <div class="control-group">
              <!-- Button -->
              <div class="controls">
                <input type="button" class="btn btn-success" id="AddNewPlace" value="Add"/>
              </div>
            </div>
            <br>
          </fieldset>
